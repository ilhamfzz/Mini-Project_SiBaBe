...
type CustomerSvc interface {
	...
	CreateCart(c echo.Context) (model.General_Cart, error)
	PostProductToCart(c echo.Context, id int) (model.General_Product_Cart, error)
	GetCart(c echo.Context) (model.Cart_View, error)
	UpdateProductFromCartPlus(c echo.Context, id int) (model.General_Product_Cart, error)
	UpdateProductFromCartMinus(c echo.Context, id int) (model.General_Product_Cart, error)
	DeleteProductFromCart(c echo.Context, id int) error
	Checkout(c echo.Context) (model.Cart_View, error)
